...
for (const key in mappings) {
  ...
  if (
    url.includes("Agriculture_in_India.jpg") ||
    url.includes("Fertilizer.jpg") ||
    url.includes("Various_seeds.jpg") ||
    url.includes("Plastic_mulch.jpg") ||
    url.includes("Knapsack_sprayer.jpg") ||
    url.includes("Grain_silos.jpg") ||
    url.includes("Insect_trap.jpg")
  ) {
...
const mappingsString =
  "const IMAGE_MAPPINGS: Record<string, string> = " + JSON.stringify(mappings, null, 2) + ";\n";
