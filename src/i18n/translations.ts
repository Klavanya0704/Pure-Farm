...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "AgriFood Processing Unit": "AgriFood Processing Unit",
    "AgriSoil Research Centre": "AgriSoil Research Centre",
    "AgriTech Field Operations Intern": "AgriTech Field Operations Intern",
    ...
    "Crop Management Intern": "Crop Management Intern",
    ...
    "Per Drop More Crop": "Per Drop More Crop",
    "Pradhan Mantri Fasal Bima Yojana": "Pradhan Mantri Fasal Bima Yojana",
    "Sub-Mission on Agricultural Mechanization": "Sub-Mission on Agricultural Mechanization",
    "Paramparagat Krishi Vikas Yojana": "Paramparagat Krishi Vikas Yojana",
    "Agri Infrastructure Fund": "Agri Infrastructure Fund",
    "Government of India": "Government of India",
    "Department of Agriculture": "Department of Agriculture",
    "NABARD and Banks": "NABARD and Banks",
    "Ministry of Agriculture": "Ministry of Agriculture",
    ...
    "Open through banks": "Open through banks",
    "State-wise annual targets": "State-wise annual targets",
    "Seasonal crop notification dates": "Seasonal crop notification dates",
    "Annual state portal window": "Annual state portal window",
    "Cluster formation drives": "Cluster formation drives",
    "Scheme duration up to 2032": "Scheme duration up to 2032",
    "₹6,000 / year financial support": "₹6,000 / year financial support",
    "Free soil testing & recommendations": "Free soil testing & recommendations",
    "Low-interest credit up to ₹3 Lakhs": "Low-interest credit up to ₹3 Lakhs",
    "55% subsidy on micro-irrigation": "55% subsidy on micro-irrigation",
    "100% crop loss risk protection": "100% crop loss risk protection",
  ...
  te: {
    ...
    "Mark as unread": "చదవనట్లు గుర్తించండి",
    ...
    "Eligibility & Benefit": "అర్హత & ప్రయోజనాలు",
    "Eligibility & Benefits": "అర్హత & ప్రయోజనాలు",
    "No schemes found": "పథకాలు ఏవీ కనుగొనబడలేదు",
    "PM-KISAN Income Support": "పిఎమ్-కిసాన్ ఆదాయ మద్దతు పథకం",
    "Soil Health Card": "నేల ఆరోగ్య పత్రం పథకం",
    "Kisan Credit Card": "కిసాన్ క్రెడిట్ కార్డ్ (KCC)",
    "Per Drop More Crop": "పర్ డ్రాప్ మోర్ క్రాప్ (సూక్ష్మ సేద్యం)",
    "Pradhan Mantri Fasal Bima Yojana": "ప్రధాన మంత్రి ఫసల్ బీమా యోజన (PMFBY)",
    "Sub-Mission on Agricultural Mechanization": "వ్యవసాయ యంత్రాల సబ్-మిషన్ (SMAM)",
    "Paramparagat Krishi Vikas Yojana": "పరంపరాగత్ కృషి వికాస్ యోజన (PKVY)",
    "Agri Infrastructure Fund": "అగ్రికల్చర్ ఇన్‌ఫ్రాస్ట్రక్చర్ ఫండ్ (AIF)",
    "Government of India": "భారత ప్రభుత్వం",
    "Department of Agriculture": "వ్యవసాయ శాఖ",
    "NABARD and Banks": "నాబార్డ్ మరియు బ్యాంకులు",
    "Ministry of Agriculture": "కేంద్ర వ్యవసాయ మంత్రిత్వ శాఖ",
    ...
    "State-wise annual targets": "వార్షిక లక్ష్యాల ఆధారంగా",
    "Seasonal crop notification dates": "సీజనల్ పంటల గడువు తేదీలు",
    "Annual state portal window": "వార్షిక పోర్టల్ విండో",
    "Cluster formation drives": "క్లస్టర్ ఏర్పాటు డ్రైవ్‌లు",
    "Scheme duration up to 2032": "2032 వరకు పథకం గడువు",
    "₹6,000 / year financial support": "ఏటా ₹6,000 ఆర్థిక సహాయం",
    "Free soil testing & recommendations": "ఉచిత నేల పరీక్ష & సిఫార్సులు",
    "Low-interest credit up to ₹3 Lakhs": "₹3 లక్షల వరకు తక్కువ వడ్డీ రుణం",
    "55% subsidy on micro-irrigation": "సూక్ష్మ సేద్యంపై 55% సబ్సిడీ",
    "100% crop loss risk protection": "100% పంట నష్ట భద్రత",
