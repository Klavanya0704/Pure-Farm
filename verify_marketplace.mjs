...
(async () => {
  ...
  await page.goto("https://fresh-produce-connect-main.vercel.app/marketplace", {
  ...
  const metrics = await page.evaluate(() => {
    ...
    const button =
      firstCard.querySelector("button.bg-\\[\\#145A43\\]") ||
      firstCard.querySelector("button:last-child");
