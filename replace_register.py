...
content = open('src/components/pages.tsx', 'r', encoding='utf-8').read()

new_register_page = """export function RegisterPage() {
...
start_idx = content.find("export function RegisterPage() {")
end_idx = content.find("export function SellerPage() {")

if start_idx != -1 and end_idx != -1:
    final_content = content[:start_idx] + new_register_page + "\n\n" + content[end_idx:]
    with open('src/components/pages.tsx', 'w', encoding='utf-8') as f:
        f.write(final_content)
    print("Successfully replaced RegisterPage!")
else:
